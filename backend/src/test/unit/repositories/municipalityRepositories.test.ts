...
describe('roleRepository', () => {
    ...
    describe('findMunicipalityRoleByName', () => {
        it('returns role when found', async () => {
            ...
            const result = await roleRepository.findMunicipalityRoleByName('Test Role');
        ...
        it('returns null when role not found', async () => {
            ...
            const result = await roleRepository.findMunicipalityRoleByName('Non-existent Role');
    ...
    describe('deleteMunicipalityRoleById', () => {
        ...
        it('propagates delete errors', async () => {
            ...
            await expect(roleRepository.deleteMunicipalityRoleById(1)).rejects.toBe(err);
        });
    });
});