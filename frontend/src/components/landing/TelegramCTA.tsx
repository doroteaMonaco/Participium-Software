    ...
    <section id="telegram" className="bg-white py-20 sm:py-24">
        <Container>
            <div className="grid items-center gap-10 lg:grid-cols-2">
                <div>
                    <SectionTitle eyebrow="Telegram bot" title="Report and get updates on the go" subtitle="Use Telegram to create reports and receive status changes instantly." />
                    <div className="mt-6 flex flex-wrap items-center gap-3">
                        <a href="#" className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700">
                            <Send className="h-4 w-4" /> Open in Telegram
                        </a>
                        <a href="#" className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-50">Learn more</a>
                    </div>
                </div>
