...
import { Droplet, Construction, Waves, Lightbulb, Trash2, TrafficCone, Navigation, Trees, HelpCircle } from "lucide-react";
...
export const Categories: React.FC = () => {
    ...
    return (
        <section id="categories" className="bg-slate-50 py-20 sm:py-24">
            <Container>
                <SectionTitle eyebrow="Categories" title="What you can report" subtitle="Help route requests to the right office." />
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {categories.map((cat, i) => (
                        <div key={i} className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg">
